...
```bash
aws ecr get-login-password --region eu-west-1 | docker login --username AWS --password-stdin 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app
```
...
```bash
docker tag edem-app:latest 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:latest
```
...
```bash
docker push 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:latest
```
...
```bash
docker tag edem-app:latest 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:v1.0
docker push 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:v1.0
```
...
```bash
docker tag edem-app:v2.0 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:v2.0
docker push 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:v2.0
```

```bash
docker build -t edem-app:latest -t 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:latest .
docker push 797978486197.dkr.ecr.eu-west-1.amazonaws.com/edem-app:latest
```
